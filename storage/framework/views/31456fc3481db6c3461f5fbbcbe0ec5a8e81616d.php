    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="list-unstyled" id="group-list">

                        <?php foreach($groups as $node_group): ?>
                            <?php
                                $value = $node_group;
                                $group_node_name = \App\MaterialGroups::find($node_group->first()->id_head_group)->name;
                            ?>



                            <li>
                                <?php echo $group_node_name; ?>

                                <ul>
                                    <?php while(isset($value->materials) == false): ?>

                                        <?php foreach($value as $group): ?>
                                            <?php $value = $group ?>

                                            <?php if($value->name == $group_node_name): ?>
                                            <?php else: ?>
                                                    <li>
                                                        <?php echo $value->name; ?>
                                    ...
                                    <?php endwhile; ?>
                                    <ul>
                                        <?php foreach($value->materials as $material): ?>
                                            <li>
